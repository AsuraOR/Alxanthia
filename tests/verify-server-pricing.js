...
// ---------------------------------------------------------------------------
console.log('--- SUITE S10: Bali orders default their shipping fee to 0 (Revision) ---');
...
assert.strictEqual(defaultShippingFee(true, 'self_pickup'), 0, 'a Bali self-pickup order must default Shipping Fee to 0, since there is no delivery to pay for at all');
...
console.log('✔ Suite S10 Passed: every Bali order gets its shipping fee auto-filled to 0, and out-of-Bali orders still need a manual entry\n');
