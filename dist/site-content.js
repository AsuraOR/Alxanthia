...
window.ALXANTHIA_DATA = {
  ...
  translations: {
    ...
    id: {
      ...
      checkoutDeliverySelfPickup: "Ambil sendiri di studio (Jimbaran)",
      checkoutAddressLabel: "Alamat lengkap pengiriman",
      checkoutCityLabel: "Kota atau kabupaten",
      checkoutPostalLabel: "Kode pos",
      checkoutPickupHelp: "Studio berlokasi di Jimbaran. Alamat pengambilan akan dikonfirmasi dan dikirimkan melalui WhatsApp.",
      checkoutPickupLocation: "Jimbaran",
    ...
    en: {
      ...
      checkoutDeliverySelfPickup: "Self pickup at the studio (Jimbaran)",
      checkoutAddressLabel: "Complete delivery address",
      checkoutCityLabel: "City or regency",
      checkoutPostalLabel: "Postal code",
      checkoutPickupHelp: "The studio is located in Jimbaran. The pickup address will be confirmed and sent via WhatsApp.",
      checkoutPickupLocation: "Jimbaran",
